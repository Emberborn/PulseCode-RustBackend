...
.data
written dq 0
adenc_objc_aden_lang_Comparable dd 0
trace_m0 db "aden.lang.Comparable.compareTo"
trace_m0_len equ 30

.code
adenc_aden_lang_Comparable_compareTo__Object proc
    sub rsp, 200
...
adenc_aden_lang_Comparable_compareTo__Object_b0:
    xor eax, eax
    jmp adenc_aden_lang_Comparable_compareTo__Object_epilogue
adenc_aden_lang_Comparable_compareTo__Object_epilogue:
    mov qword ptr [rsp+120], rax
    mov rax, qword ptr [rsp+120]
adenc_aden_lang_Comparable_compareTo__Object_epilogue_post:
    mov qword ptr [rsp+120], rax
    call adenc_rt_tracePop
    mov rax, qword ptr [rsp+120]
    add rsp, 200
    ret
adenc_aden_lang_Comparable_compareTo__Object endp
