...
.data
written dq 0
adenc_objc_aden_interop_NativeCallback1 dd 0
trace_m0 db "aden.interop.NativeCallback1.invoke"
trace_m0_len equ 35

.code
adenc_aden_interop_NativeCallback1_invoke__long proc
    sub rsp, 200
...
adenc_aden_interop_NativeCallback1_invoke__long_b0:
    xor eax, eax
    jmp adenc_aden_interop_NativeCallback1_invoke__long_epilogue
adenc_aden_interop_NativeCallback1_invoke__long_epilogue:
    mov qword ptr [rsp+120], rax
    mov rax, qword ptr [rsp+120]
adenc_aden_interop_NativeCallback1_invoke__long_epilogue_post:
    mov qword ptr [rsp+120], rax
    call adenc_rt_tracePop
    mov rax, qword ptr [rsp+120]
    add rsp, 200
    ret
adenc_aden_interop_NativeCallback1_invoke__long endp
