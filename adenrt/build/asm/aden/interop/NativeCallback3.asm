...
.data
written dq 0
adenc_objc_aden_interop_NativeCallback3 dd 0
trace_m0 db "aden.interop.NativeCallback3.invoke"
trace_m0_len equ 35

.code
adenc_aden_interop_NativeCallback3_invoke__long_long_long proc
    sub rsp, 216
...
adenc_aden_interop_NativeCallback3_invoke__long_long_long_b0:
    xor eax, eax
    jmp adenc_aden_interop_NativeCallback3_invoke__long_long_long_epilogue
adenc_aden_interop_NativeCallback3_invoke__long_long_long_epilogue:
    mov qword ptr [rsp+136], rax
    mov rax, qword ptr [rsp+136]
adenc_aden_interop_NativeCallback3_invoke__long_long_long_epilogue_post:
    mov qword ptr [rsp+136], rax
    call adenc_rt_tracePop
    mov rax, qword ptr [rsp+136]
    add rsp, 216
    ret
adenc_aden_interop_NativeCallback3_invoke__long_long_long endp
