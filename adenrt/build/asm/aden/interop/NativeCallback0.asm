...
.data
written dq 0
adenc_objc_aden_interop_NativeCallback0 dd 0
trace_m0 db "aden.interop.NativeCallback0.invoke"
trace_m0_len equ 35

.code
adenc_aden_interop_NativeCallback0_invoke proc
    sub rsp, 200
...
adenc_aden_interop_NativeCallback0_invoke_b0:
    xor eax, eax
    jmp adenc_aden_interop_NativeCallback0_invoke_epilogue
adenc_aden_interop_NativeCallback0_invoke_epilogue:
    mov qword ptr [rsp+112], rax
    mov rax, qword ptr [rsp+112]
adenc_aden_interop_NativeCallback0_invoke_epilogue_post:
    mov qword ptr [rsp+112], rax
    call adenc_rt_tracePop
    mov rax, qword ptr [rsp+112]
    add rsp, 200
    ret
adenc_aden_interop_NativeCallback0_invoke endp
