...
trace_m0_len equ 28
pulsec_strict_stress_soak_Main_main_trace_s0 db "strict_stress_soak.Main.main(Main.pulse:7)"
pulsec_strict_stress_soak_Main_main_trace_s0_len equ 42
pulsec_strict_stress_soak_Main_main_trace_s1 db "strict_stress_soak.Main.main(Main.pulse:8)"
pulsec_strict_stress_soak_Main_main_trace_s1_len equ 42
pulsec_strict_stress_soak_Main_main_trace_s2 db "strict_stress_soak.Main.main(Main.pulse:9)"
pulsec_strict_stress_soak_Main_main_trace_s2_len equ 42
pulsec_strict_stress_soak_Main_main_trace_s3 db "strict_stress_soak.Main.main(Main.pulse:10)"
pulsec_strict_stress_soak_Main_main_trace_s3_len equ 43
pulsec_strict_stress_soak_Main_main_trace_s4 db "strict_stress_soak.Main.main(Main.pulse:11)"
pulsec_strict_stress_soak_Main_main_trace_s4_len equ 43
pulsec_strict_stress_soak_Main_main_trace_s5 db "strict_stress_soak.Main.main(Main.pulse:13)"
pulsec_strict_stress_soak_Main_main_trace_s5_len equ 43
pulsec_strict_stress_soak_Main_main_trace_s6 db "strict_stress_soak.Main.main(Main.pulse:14)"
pulsec_strict_stress_soak_Main_main_trace_s6_len equ 43
msg0 db "soak_ok"
msg0_len equ 7
msg1 db "soak_bad"
msg1_len equ 8
...
pulsec_strict_stress_soak_Main_main_b0:
    lea rcx, pulsec_strict_stress_soak_Main_main_trace_s0
    mov edx, pulsec_strict_stress_soak_Main_main_trace_s0_len
    ...
    lea rcx, pulsec_strict_stress_soak_Main_main_trace_s1
    mov edx, pulsec_strict_stress_soak_Main_main_trace_s1_len
    call pulsec_rt_traceUpdateTop
    mov rax, qword ptr [rsp+64]
...
Main_main_vd1_4_done:
    ...
    lea rcx, pulsec_strict_stress_soak_Main_main_trace_s2
    mov edx, pulsec_strict_stress_soak_Main_main_trace_s2_len
    call pulsec_rt_traceUpdateTop
...
pulsec_strict_stress_soak_Main_main_b1:
    lea rcx, pulsec_strict_stress_soak_Main_main_trace_s3
    mov edx, pulsec_strict_stress_soak_Main_main_trace_s3_len
    call pulsec_rt_traceUpdateTop
    lea rcx, msg0
    mov edx, msg0_len
    ...
    call pulsec_rt_arcRelease
    mov rax, qword ptr [rsp+128]
    lea rcx, pulsec_strict_stress_soak_Main_main_trace_s4
    mov edx, pulsec_strict_stress_soak_Main_main_trace_s4_len
    call pulsec_rt_traceUpdateTop
    mov eax, dword ptr [rsp+72]
    mov qword ptr [rsp+128], rax
    mov rax, qword ptr [rsp+128]
...
pulsec_strict_stress_soak_Main_main_b2:
    lea rcx, pulsec_strict_stress_soak_Main_main_trace_s5
    mov edx, pulsec_strict_stress_soak_Main_main_trace_s5_len
    call pulsec_rt_traceUpdateTop
    lea rcx, msg1
    mov edx, msg1_len
    call pulsec_rt_stringFromBytes
    ...
    call pulsec_rt_arcRelease
    mov rax, qword ptr [rsp+128]
    lea rcx, pulsec_strict_stress_soak_Main_main_trace_s6
    mov edx, pulsec_strict_stress_soak_Main_main_trace_s6_len
    call pulsec_rt_traceUpdateTop
    mov eax, dword ptr [rsp+72]
    mov qword ptr [rsp+128], rax
    mov rax, qword ptr [rsp+128]
