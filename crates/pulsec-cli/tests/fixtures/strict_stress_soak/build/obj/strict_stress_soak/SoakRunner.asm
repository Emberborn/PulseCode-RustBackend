...
pulsec_strict_stress_soak_SoakRunner_run__int_b2:
    ...
    mov rcx, rax
    cmp ecx, 0
    je SoakRunner_run_vd11_23_null
    call pulsec_strict_stress_soak_Token_value
    jmp SoakRunner_run_vd11_23_done
SoakRunner_run_vd11_23_null:
    call pulsec_rt_dispatchNullReceiverPanic
SoakRunner_run_vd11_23_done:
...
pulsec_strict_stress_soak_SoakRunner_run__int_vd_stmt_2_12_4_done:
    ...
    mov rcx, rax
    cmp ecx, 0
    je SoakRunner_run_vd13_30_null
    call pulsec_com_pulse_collections_ArrayList_size
    jmp SoakRunner_run_vd13_30_done
SoakRunner_run_vd13_30_null:
    call pulsec_rt_dispatchNullReceiverPanic
SoakRunner_run_vd13_30_done:
...
pulsec_strict_stress_soak_SoakRunner_run__int_vd_stmt_6_15_0_done:
    ...
    mov rcx, rax
    cmp ecx, 0
    je SoakRunner_run_vd16_42_null
    call pulsec_com_pulse_collections_LinkedList_size
    jmp SoakRunner_run_vd16_42_done
SoakRunner_run_vd16_42_null:
    call pulsec_rt_dispatchNullReceiverPanic
SoakRunner_run_vd16_42_done:
...
pulsec_strict_stress_soak_SoakRunner_run__int_b7:
    ...
    mov rcx, rax
    cmp ecx, 0
    je SoakRunner_run_vd17_49_null
    call pulsec_com_pulse_collections_LinkedList_poll
    jmp SoakRunner_run_vd17_49_done
SoakRunner_run_vd17_49_null:
    call pulsec_rt_dispatchNullReceiverPanic
SoakRunner_run_vd17_49_done:
    mov edx, eax
...
pulsec_strict_stress_soak_SoakRunner_run__int_b16:
    ...
    mov rcx, rax
    cmp ecx, 0
    je SoakRunner_run_vd29_93_null
    call pulsec_com_pulse_collections_LinkedList_size
    jmp SoakRunner_run_vd29_93_done
SoakRunner_run_vd29_93_null:
    call pulsec_rt_dispatchNullReceiverPanic
SoakRunner_run_vd29_93_done:
...
pulsec_strict_stress_soak_SoakRunner_run__int_b17:
    ...
    mov rcx, rax
    cmp ecx, 0
    je SoakRunner_run_vd30_100_null
    call pulsec_com_pulse_collections_LinkedList_poll
    jmp SoakRunner_run_vd30_100_done
SoakRunner_run_vd30_100_null:
    call pulsec_rt_dispatchNullReceiverPanic
SoakRunner_run_vd30_100_done:
    mov edx, eax
...
pulsec_strict_stress_soak_SoakRunner_run__int_b18:
    ...
    mov rcx, rax
    cmp ecx, 0
    je SoakRunner_run_vd31_105_null
    call pulsec_com_pulse_collections_HashMap_getInt__String
    jmp SoakRunner_run_vd31_105_done
SoakRunner_run_vd31_105_null:
    call pulsec_rt_dispatchNullReceiverPanic
SoakRunner_run_vd31_105_done:
    mov qword ptr [rsp+360], rax
    mov rax, qword ptr [rsp+320]
    mov rcx, rax
    call pulsec_rt_arcRelease
    ...
    mov rcx, rax
    cmp ecx, 0
    je SoakRunner_run_vd32_108_null
    call pulsec_com_pulse_collections_HashSet_size
    jmp SoakRunner_run_vd32_108_done
SoakRunner_run_vd32_108_null:
    call pulsec_rt_dispatchNullReceiverPanic
SoakRunner_run_vd32_108_done:
    mov dword ptr [rsp+160], eax
    mov rax, qword ptr [rsp+64]
    mov rcx, rax
    cmp ecx, 0
    je SoakRunner_run_vd33_111_null
    call pulsec_com_pulse_collections_ArrayList_size
    jmp SoakRunner_run_vd33_111_done
SoakRunner_run_vd33_111_null:
    call pulsec_rt_dispatchNullReceiverPanic
SoakRunner_run_vd33_111_done:
