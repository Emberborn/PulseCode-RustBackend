...
trace_m1 db "com.pulse.lang.NumberFormatException.NumberFormatException"
trace_m1_len equ $ - trace_m1
trace_m2 db "com.pulse.lang.NumberFormatException.toString"
...
pulsec_com_pulse_lang_NumberFormatException_toString_b0:
    ...
    cmp ecx, 0
    je NumberFormatException_toString_vd0_2_null
    call pulsec_com_pulse_lang_Throwable_getMessage
    jmp NumberFormatException_toString_vd0_2_done
NumberFormatException_toString_vd0_2_null:
    call pulsec_rt_dispatchNullReceiverPanic
NumberFormatException_toString_vd0_2_done:
