...
trace_m1 db "com.pulse.lang.IndexOutOfBoundsException.IndexOutOfBoundsException"
trace_m1_len equ $ - trace_m1
trace_m2 db "com.pulse.lang.IndexOutOfBoundsException.toString"
...
pulsec_com_pulse_lang_IndexOutOfBoundsException_toString_b0:
    ...
    cmp ecx, 0
    je IndexOutOfBoundsException_toString_vd0_2_null
    call pulsec_com_pulse_lang_Throwable_getMessage
    jmp IndexOutOfBoundsException_toString_vd0_2_done
IndexOutOfBoundsException_toString_vd0_2_null:
    call pulsec_rt_dispatchNullReceiverPanic
IndexOutOfBoundsException_toString_vd0_2_done:
