...
trace_m0 db "com.pulse.lang.UnsupportedOperationException.UnsupportedOperationException"
trace_m0_len equ $ - trace_m0
trace_m1 db "com.pulse.lang.UnsupportedOperationException.UnsupportedOperationException"
trace_m1_len equ $ - trace_m1
trace_m2 db "com.pulse.lang.UnsupportedOperationException.toString"
...
pulsec_com_pulse_lang_UnsupportedOperationException_toString_b0:
    ...
    cmp ecx, 0
    je UnsupportedOperationException_toString_vd0_2_null
    call pulsec_com_pulse_lang_Throwable_getMessage
    jmp UnsupportedOperationException_toString_vd0_2_done
UnsupportedOperationException_toString_vd0_2_null:
    call pulsec_rt_dispatchNullReceiverPanic
UnsupportedOperationException_toString_vd0_2_done:
