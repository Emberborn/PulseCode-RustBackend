...
extrn pulsec_fcap_com_pulse_collections_LinkedList_arc_teardown:proc
extrn pulsec_fcap_com_pulse_collections_LinkedList_arc_scan_edges:proc
extrn pulsec_fcap_com_pulse_collections_LinkedList_arc_invalidate_edges:proc
...
pulsec_rt_obj_class_ids_init dd 256 dup(0)

public rt_slot_capacity
rt_handle_next dd 0
rt_slot_capacity dd 255
...
rt_arr_count dd 0
rt_arr_len dd 256 dup(0)
rt_arr_alive dd 256 dup(0)
rt_arr_i_ptr dq 256 dup(0)
rt_arr_s_ptr dq 256 dup(0)
...
rt_list_count dd 0
rt_list_size dd 256 dup(0)
rt_list_cap dd 256 dup(0)
rt_list_alive dd 256 dup(0)
rt_list_kind dd 256 dup(0)
rt_list_i_ptr dq 256 dup(0)
rt_list_s_ptr dq 256 dup(0)
...
rt_map_count dd 0
rt_map_size dd 256 dup(0)
rt_map_cap dd 256 dup(0)
rt_map_alive dd 256 dup(0)
rt_map_keys_ptr dq 256 dup(0)
rt_map_tags_ptr dq 256 dup(0)
rt_map_i_ptr dq 256 dup(0)
rt_map_s_ptr dq 256 dup(0)
...
rt_arc_refcounts_tbl dd 256 dup(0)
rt_arc_kinds_tbl dd 256 dup(0)
rt_arc_flags_tbl dd 256 dup(0)
rt_arc_meta_tbl dd 256 dup(0)
rt_arc_generation_tbl dd 256 dup(0)
rt_arc_free_head dd 0
rt_arc_free_next_tbl dd 256 dup(0)
...
rt_weak_free_next dd 256 dup(0)
rt_weak_target_slot dd 256 dup(0)
rt_weak_target_gen dd 256 dup(0)
rt_weak_generation dd 256 dup(0)
...
pulsec_rt_arcTeardown_kind_object:
    ...
    cmp edx, 41
    je pulsec_rt_arcTeardown_kind_object_c41
    cmp edx, 44
    je pulsec_rt_arcTeardown_kind_object_c44
    jmp pulsec_rt_arcTeardown_kind_object_unmatched
pulsec_rt_arcTeardown_kind_object_c7:
    call pulsec_fcap_com_pulse_collections_LinkedList_arc_teardown
...
pulsec_rt_arcTeardown_kind_object_c17:
    ...
    mov ecx, dword ptr [rt_tmp_arr_slot]
    jmp pulsec_rt_arcTeardown_kind_object_done
pulsec_rt_arcTeardown_kind_object_c41:
    call pulsec_fcap_com_pulse_lang_StringBuilder_arc_teardown
    mov ecx, dword ptr [rt_tmp_arr_slot]
    jmp pulsec_rt_arcTeardown_kind_object_done
pulsec_rt_arcTeardown_kind_object_c44:
...
pulsec_rt_arcCycleFullPass_scan_edges_loop:
    ...
    cmp edx, 41
    je pulsec_rt_arcCycleFullPass_scan_edges_c41
    cmp edx, 44
    je pulsec_rt_arcCycleFullPass_scan_edges_c44
    jmp pulsec_rt_arcCycleFullPass_scan_edges_unmatched
pulsec_rt_arcCycleFullPass_scan_edges_c7:
    mov ecx, r8d
    call pulsec_fcap_com_pulse_collections_LinkedList_arc_scan_edges
...
pulsec_rt_arcCycleFullPass_scan_edges_c17:
    ...
    jmp pulsec_rt_arcCycleFullPass_scan_edges_next
pulsec_rt_arcCycleFullPass_scan_edges_c41:
    mov ecx, r8d
    call pulsec_fcap_com_pulse_lang_StringBuilder_arc_scan_edges
    jmp pulsec_rt_arcCycleFullPass_scan_edges_next
pulsec_rt_arcCycleFullPass_scan_edges_c44:
    mov ecx, r8d
...
pulsec_rt_arcCycleFullPass_invalidate_loop:
    ...
    cmp edx, 41
    je pulsec_rt_arcCycleFullPass_invalidate_c41
    cmp edx, 44
    je pulsec_rt_arcCycleFullPass_invalidate_c44
    jmp pulsec_rt_arcCycleFullPass_invalidate_unmatched
pulsec_rt_arcCycleFullPass_invalidate_c7:
    mov ecx, r8d
    call pulsec_fcap_com_pulse_collections_LinkedList_arc_invalidate_edges
...
pulsec_rt_arcCycleFullPass_invalidate_c17:
    ...
    jmp pulsec_rt_arcCycleFullPass_invalidate_next
pulsec_rt_arcCycleFullPass_invalidate_c41:
    mov ecx, r8d
    call pulsec_fcap_com_pulse_lang_StringBuilder_arc_invalidate_edges
    jmp pulsec_rt_arcCycleFullPass_invalidate_next
pulsec_rt_arcCycleFullPass_invalidate_c44:
    mov ecx, r8d
...
pulsec_rt_mapNew_allocslot_done:
    ...
    mov r11, qword ptr [rt_map_keys_ptr_ptr]
    mov qword ptr [r11+r10*8], rax
    mov eax, dword ptr [rt_map_cap_ptr+r10*4]
    shl rax, 2
    mov qword ptr [rt_tmp_arr_bytes], rax
    sub rsp, 40
    call GetProcessHeap
