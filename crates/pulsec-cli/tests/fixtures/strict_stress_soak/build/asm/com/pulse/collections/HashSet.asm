...
public pulsec_fld_com_pulse_collections_HashSet_handle
public pulsec_fld_com_pulse_collections_HashSet_handle_heap_owned

.data
written dq 0
pulsec_objc_com_pulse_collections_HashSet dd 0
pulsec_fcap_com_pulse_collections_HashSet dd 255
pulsec_fld_com_pulse_collections_HashSet_handle_tbl dq 256 dup(0)
pulsec_fld_com_pulse_collections_HashSet_handle dq pulsec_fld_com_pulse_collections_HashSet_handle_tbl
pulsec_fld_com_pulse_collections_HashSet_handle_heap_owned dd 0
trace_m0 db "com.pulse.collections.HashSet.HashSet"
trace_m0_len equ $ - trace_m0
trace_m1 db "com.pulse.collections.HashSet.size"
trace_m1_len equ $ - trace_m1
trace_m2 db "com.pulse.collections.HashSet.clear"
trace_m2_len equ $ - trace_m2
trace_m3 db "com.pulse.collections.HashSet.add"
trace_m3_len equ $ - trace_m3
trace_m4 db "com.pulse.collections.HashSet.contains"
trace_m4_len equ $ - trace_m4

.code
pulsec_fcap_com_pulse_collections_HashSet_ensure proc
    cmp ecx, 1
    jb pulsec_fcap_com_pulse_collections_HashSet_ensure_done_ok
    cmp ecx, dword ptr [pulsec_fcap_com_pulse_collections_HashSet]
    jbe pulsec_fcap_com_pulse_collections_HashSet_ensure_done_ok
    sub rsp, 88
    ...
    mov eax, dword ptr [pulsec_fcap_com_pulse_collections_HashSet]
    mov dword ptr [rsp+84], eax
    call GetProcessHeap
    test rax, rax
    jz pulsec_fcap_com_pulse_collections_HashSet_ensure_fail
    mov r13, rax
    ...
    call HeapAlloc
    test rax, rax
    jz pulsec_fcap_com_pulse_collections_HashSet_ensure_alloc_fail
    mov r12, rax
    mov rbx, qword ptr [pulsec_fld_com_pulse_collections_HashSet_handle]
    xor esi, esi
pulsec_fcap_com_pulse_collections_HashSet_ensure_field_0_done_copy_loop:
    cmp esi, dword ptr [rsp+84]
    ja pulsec_fcap_com_pulse_collections_HashSet_ensure_field_0_done
    test rbx, rbx
    jz pulsec_fcap_com_pulse_collections_HashSet_ensure_field_0_done_next
    mov rax, qword ptr [rbx+rsi*8]
    mov qword ptr [r12+rsi*8], rax
pulsec_fcap_com_pulse_collections_HashSet_ensure_field_0_done_next:
    add esi, 1
    jmp pulsec_fcap_com_pulse_collections_HashSet_ensure_field_0_done_copy_loop
pulsec_fcap_com_pulse_collections_HashSet_ensure_field_0_done:
    cmp dword ptr [pulsec_fld_com_pulse_collections_HashSet_handle_heap_owned], 0
    je pulsec_fcap_com_pulse_collections_HashSet_ensure_field_0_done_commit
    test rbx, rbx
    jz pulsec_fcap_com_pulse_collections_HashSet_ensure_field_0_done_commit
    mov rcx, r13
    xor edx, edx
    mov r8, rbx
    call HeapFree
pulsec_fcap_com_pulse_collections_HashSet_ensure_field_0_done_commit:
    mov qword ptr [pulsec_fld_com_pulse_collections_HashSet_handle], r12
    mov dword ptr [pulsec_fld_com_pulse_collections_HashSet_handle_heap_owned], 1
    mov eax, dword ptr [rt_slot_capacity]
    mov dword ptr [pulsec_fcap_com_pulse_collections_HashSet], eax
    ...
    add rsp, 88
pulsec_fcap_com_pulse_collections_HashSet_ensure_done_ok:
    xor eax, eax
    ret
pulsec_fcap_com_pulse_collections_HashSet_ensure_alloc_fail:
pulsec_fcap_com_pulse_collections_HashSet_ensure_fail:
    mov ecx, 1
    call ExitProcess
    xor eax, eax
    ret
pulsec_fcap_com_pulse_collections_HashSet_ensure endp
...
pulsec_com_pulse_collections_HashSet_HashSet proc
    ...
    mov ecx, eax
    call pulsec_fcap_com_pulse_collections_HashSet_ensure
...
pulsec_com_pulse_collections_HashSet_HashSet_b0:
    ...
    mov edx, 4294967295
@@:
    mov r10, qword ptr [pulsec_fld_com_pulse_collections_HashSet_handle]
