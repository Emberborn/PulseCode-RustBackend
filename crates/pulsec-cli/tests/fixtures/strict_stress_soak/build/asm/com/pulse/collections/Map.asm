...
public pulsec_fld_com_pulse_collections_Map_handle
public pulsec_fld_com_pulse_collections_Map_handle_heap_owned

.data
written dq 0
pulsec_objc_com_pulse_collections_Map dd 0
pulsec_fcap_com_pulse_collections_Map dd 255
pulsec_fld_com_pulse_collections_Map_handle_tbl dq 256 dup(0)
pulsec_fld_com_pulse_collections_Map_handle dq pulsec_fld_com_pulse_collections_Map_handle_tbl
pulsec_fld_com_pulse_collections_Map_handle_heap_owned dd 0
trace_m0 db "com.pulse.collections.Map.Map"
trace_m0_len equ $ - trace_m0
trace_m1 db "com.pulse.collections.Map.size"
trace_m1_len equ $ - trace_m1
trace_m2 db "com.pulse.collections.Map.clear"
trace_m2_len equ $ - trace_m2
trace_m3 db "com.pulse.collections.Map.containsKey"
trace_m3_len equ $ - trace_m3
trace_m4 db "com.pulse.collections.Map.put"
trace_m4_len equ $ - trace_m4
trace_m5 db "com.pulse.collections.Map.putInt"
trace_m5_len equ $ - trace_m5
trace_m6 db "com.pulse.collections.Map.get"
trace_m6_len equ $ - trace_m6
trace_m7 db "com.pulse.collections.Map.getInt"
trace_m7_len equ $ - trace_m7

.code
pulsec_fcap_com_pulse_collections_Map_ensure proc
    cmp ecx, 1
    jb pulsec_fcap_com_pulse_collections_Map_ensure_done_ok
    cmp ecx, dword ptr [pulsec_fcap_com_pulse_collections_Map]
    jbe pulsec_fcap_com_pulse_collections_Map_ensure_done_ok
    sub rsp, 88
    ...
    mov eax, dword ptr [pulsec_fcap_com_pulse_collections_Map]
    mov dword ptr [rsp+84], eax
    call GetProcessHeap
    test rax, rax
    jz pulsec_fcap_com_pulse_collections_Map_ensure_fail
    mov r13, rax
    ...
    call HeapAlloc
    test rax, rax
    jz pulsec_fcap_com_pulse_collections_Map_ensure_alloc_fail
    mov r12, rax
    mov rbx, qword ptr [pulsec_fld_com_pulse_collections_Map_handle]
    xor esi, esi
pulsec_fcap_com_pulse_collections_Map_ensure_field_0_done_copy_loop:
    cmp esi, dword ptr [rsp+84]
    ja pulsec_fcap_com_pulse_collections_Map_ensure_field_0_done
    test rbx, rbx
    jz pulsec_fcap_com_pulse_collections_Map_ensure_field_0_done_next
    mov rax, qword ptr [rbx+rsi*8]
    mov qword ptr [r12+rsi*8], rax
pulsec_fcap_com_pulse_collections_Map_ensure_field_0_done_next:
    add esi, 1
    jmp pulsec_fcap_com_pulse_collections_Map_ensure_field_0_done_copy_loop
pulsec_fcap_com_pulse_collections_Map_ensure_field_0_done:
    cmp dword ptr [pulsec_fld_com_pulse_collections_Map_handle_heap_owned], 0
    je pulsec_fcap_com_pulse_collections_Map_ensure_field_0_done_commit
    test rbx, rbx
    jz pulsec_fcap_com_pulse_collections_Map_ensure_field_0_done_commit
    mov rcx, r13
    xor edx, edx
    mov r8, rbx
    call HeapFree
pulsec_fcap_com_pulse_collections_Map_ensure_field_0_done_commit:
    mov qword ptr [pulsec_fld_com_pulse_collections_Map_handle], r12
    mov dword ptr [pulsec_fld_com_pulse_collections_Map_handle_heap_owned], 1
    mov eax, dword ptr [rt_slot_capacity]
    mov dword ptr [pulsec_fcap_com_pulse_collections_Map], eax
    ...
    add rsp, 88
pulsec_fcap_com_pulse_collections_Map_ensure_done_ok:
    xor eax, eax
    ret
pulsec_fcap_com_pulse_collections_Map_ensure_alloc_fail:
pulsec_fcap_com_pulse_collections_Map_ensure_fail:
    mov ecx, 1
    call ExitProcess
    xor eax, eax
    ret
pulsec_fcap_com_pulse_collections_Map_ensure endp
...
pulsec_com_pulse_collections_Map_Map proc
    ...
    mov ecx, eax
    call pulsec_fcap_com_pulse_collections_Map_ensure
...
pulsec_com_pulse_collections_Map_Map_b0:
    ...
    mov edx, 4294967295
@@:
    mov r10, qword ptr [pulsec_fld_com_pulse_collections_Map_handle]
