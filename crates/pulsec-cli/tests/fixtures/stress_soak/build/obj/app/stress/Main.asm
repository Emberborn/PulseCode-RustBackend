...
trace_m0_len equ 20
pulsec_app_stress_Main_main_trace_s0 db "app.stress.Main.main(Main.pulse:7)"
pulsec_app_stress_Main_main_trace_s0_len equ 34
pulsec_app_stress_Main_main_trace_s1 db "app.stress.Main.main(Main.pulse:8)"
pulsec_app_stress_Main_main_trace_s1_len equ 34
pulsec_app_stress_Main_main_trace_s2 db "app.stress.Main.main(Main.pulse:9)"
pulsec_app_stress_Main_main_trace_s2_len equ 34
pulsec_app_stress_Main_main_trace_s3 db "app.stress.Main.main(Main.pulse:10)"
pulsec_app_stress_Main_main_trace_s3_len equ 35
pulsec_app_stress_Main_main_trace_s4 db "app.stress.Main.main(Main.pulse:11)"
pulsec_app_stress_Main_main_trace_s4_len equ 35
pulsec_app_stress_Main_main_trace_s5 db "app.stress.Main.main(Main.pulse:13)"
pulsec_app_stress_Main_main_trace_s5_len equ 35
pulsec_app_stress_Main_main_trace_s6 db "app.stress.Main.main(Main.pulse:14)"
