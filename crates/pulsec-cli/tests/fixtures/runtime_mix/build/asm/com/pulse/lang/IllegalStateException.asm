...
pulsec_com_pulse_lang_IllegalStateException_IllegalStateException_trace_s0_len equ 90
...
pulsec_com_pulse_lang_IllegalStateException_IllegalStateException__String_trace_s0_len equ 90
...
pulsec_com_pulse_lang_IllegalStateException_IllegalStateException__String_Throwable_trace_s0_len equ 90
