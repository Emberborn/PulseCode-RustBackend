...
pulsec_com_pulse_lang_Byte_valueOf__byte_trace_s0_len equ 42
...
pulsec_com_pulse_lang_Byte_byteValue__Byte_trace_s0_len equ 44
...
pulsec_com_pulse_lang_Byte_toString__byte_trace_s0_len equ 43
