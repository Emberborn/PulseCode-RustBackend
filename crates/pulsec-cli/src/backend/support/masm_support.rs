use super::*;
use pulsec_core::intermediate::IrValue;
...
pub(crate) const STATIC_STORAGE_SCHEMA: &str = "pulsec.static.storage.v1";
pub(crate) const CONSTRUCTOR_MODEL_SCHEMA: &str = "pulsec.constructor.model.v1";
pub(crate) const CLASS_ALLOC_SCHEMA: &str = "pulsec.class.alloc.v1";
pub(crate) const DISPATCH_SCHEMA: &str = "pulsec.dispatch.schema.v1";
pub(crate) const TYPE_ID_SCHEMA: &str = "pulsec.typeid.schema.v1";
pub(crate) const OBJECT_MODEL_ABI_SCHEMA: &str = "pulsec.object_model.abi.v1";
