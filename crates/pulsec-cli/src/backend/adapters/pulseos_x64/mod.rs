// RB-13 contract ownership: this module publishes the first PulseOS x64 runtime-service ABI
...
pub(crate) struct PulseOsRuntimeServiceContract {
...
static PULSEOS_X64_RUNTIME_SERVICE_CONTRACT: PulseOsRuntimeServiceContract =
    PulseOsRuntimeServiceContract {
        ...
        purpose: "define the minimum requested-target PulseOS service ABI slice without inheriting Windows host-bootstrap imports or startup naming",
        console_capabilities: &[
            "pulseos.console.write_utf8",
            "pulseos.console.write_line_utf8",
        ],
        panic_capabilities: &["pulseos.panic.abort_utf8"],
        process_capabilities: &["pulseos.process.exit_i32"],
        path_capabilities: &["pulseos.path.program_dir_utf8"],
        file_capabilities: &[
...
static PULSEOS_X64_LOADING_PROOF_SUCCESS_CONDITIONS: &[&str] = &[
    ...
    "startup-entry-symbol-pulseos_start-is-resolvable",
...
pub(crate) fn pulseos_x64_runtime_service_contract() -> &'static PulseOsRuntimeServiceContract {
    &PULSEOS_X64_RUNTIME_SERVICE_CONTRACT
}

pub(crate) fn pulseos_x64_artifact_contract(output_mode: &str) -> TargetArtifactContract {
    match output_mode {
...
pub(crate) fn pulseos_x64_startup_loader_contract(
    output_mode: &str,
    ...
    match output_mode {
        "shared" => TargetStartupLoaderContract {
            ...
            loader_manifest_schema: Some("pulsec.pulseos.launch.v1"),
...
pub(crate) fn pulseos_x64_executable_loading_proof_target(
    output_mode: &str,
