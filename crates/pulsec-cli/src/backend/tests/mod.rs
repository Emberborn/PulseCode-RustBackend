...
fn rb_12_native_plan_emits_host_bootstrap_runtime_contract() {
    ...
    for needle in [
        ...
        "\"runtime_service_imports\": [\"GetStdHandle\", \"WriteFile\", \"ExitProcess\", \"GetProcessHeap\", \"HeapAlloc\", \"HeapFree\", \"GetSystemTimeAsFileTime\", \"LoadLibraryA\", \"FreeLibrary\", \"GetProcAddress\", \"CreateProcessA\", \"WaitForSingleObject\", \"GetExitCodeProcess\"]",
...
fn rb_14_native_plan_emits_runtime_ownership_model() {
    ...
    for needle in [
        ...
        "\"active_adapter_service_imports\": [\"GetStdHandle\", \"WriteFile\", \"ExitProcess\", \"GetProcessHeap\", \"HeapAlloc\", \"HeapFree\", \"GetSystemTimeAsFileTime\", \"LoadLibraryA\", \"FreeLibrary\", \"GetProcAddress\", \"CreateProcessA\", \"WaitForSingleObject\", \"GetExitCodeProcess\"]",
