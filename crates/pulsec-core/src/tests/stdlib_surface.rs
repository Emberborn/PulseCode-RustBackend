...
fn check_accepts_com_pulse_math_and_collections_baseline() {
    ...
    check(src).expect("pulse baseline classes should typecheck");
}
...
fn check_accepts_static_imports_from_com_pulse_math() {
    let src = r#"
        package app.core;
        import pulse.lang.IO;
        import static pulse.math.Math.PI;
        import static pulse.math.Math.abs;
    ...
    check(src).expect("static imports from pulse math should typecheck");
}
    ...
    let src = r#"
        ...
        class Main {
            public static void main() {
                ...
                boolean same = value.equals(Optional.of("pulse"));
        ...
        class Main {
            public static void main() {
                ...
                String paddedLeft = "7".padLeft(3, '0');
                  ...
                  boolean contentEquals = "pulse".contentEquals((CharSequence) "pulse");
                  boolean region = "PulseCode".regionMatches(5, "coder", 0, 3);
                  boolean regionIgnoreCase = "PulseCode".regionMatches(true, 0, "pulse", 0, 5);
                  String lower = "PuLsE".toLowerCase();
                  String upper = "PuLsE".toUpperCase();
                  boolean sameIgnoreCase = "Pulse".equalsIgnoreCase("pUlSe");
                boolean blank = " \t\n".isBlank();
                String stripped = "  pulse  ".strip();
                String leading = "  pulse".stripLeading();
                String trailing = "pulse  ".stripTrailing();
                int textHash = "pulse".hashCode();
                ...
                boolean builderContentEquals = new StringBuilder("pulse").contentEquals((CharSequence) "pulse");
    ...
    let src = r#"
        ...
        class Main {
            public static void main() {
                ...
                int stringPos = list.lastIndexOf("pulse");

                List linked = new LinkedList();
                linked.add("pulse");
                linked.add("code");
                linked.add("pulse");
                int linkedPos = linked.lastIndexOf("pulse");
            }
        }
    "#;
    ...
    let src = r#"
        ...
        class Main {
            public static void main() {
                ...
                map.put("name", "pulse");
                map.putInt("hp", 7);
                boolean hasName = map.containsValue("pulse");
...
fn check_accepts_hashmap_hashset_default_and_bulk_query_helpers() {
    let src = r#"
        ...
        class Main {
            public static void main() {
                Map map = new HashMap();
                Object prior = map.putIfAbsent("name", "pulse");
    ...
    let src = r#"
        ...
        class Main {
            public static void main() {
                ...
                boolean has = Arrays.contains(values, "pulse");

                Collection sink = new ArrayList();
                boolean changed = Collections.addAll(sink, copied);
                int freq = Collections.frequency(copied, "pulse");
    ...
    let src = r#"
        ...
        class Main {
            public static void main() {
                ...
                boolean hadWord = bag.contains("pulse");
