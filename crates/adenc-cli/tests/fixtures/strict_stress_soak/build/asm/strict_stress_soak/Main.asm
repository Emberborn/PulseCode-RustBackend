...
trace_m0_len equ 28
pulsec_strict_stress_soak_Main_main_trace_s0 db "strict_stress_soak.Main.main(Main.aden:7)"
pulsec_strict_stress_soak_Main_main_trace_s0_len equ 42
pulsec_strict_stress_soak_Main_main_trace_s1 db "strict_stress_soak.Main.main(Main.aden:8)"
pulsec_strict_stress_soak_Main_main_trace_s1_len equ 42
pulsec_strict_stress_soak_Main_main_trace_s2 db "strict_stress_soak.Main.main(Main.aden:9)"
pulsec_strict_stress_soak_Main_main_trace_s2_len equ 42
pulsec_strict_stress_soak_Main_main_trace_s3 db "strict_stress_soak.Main.main(Main.aden:10)"
pulsec_strict_stress_soak_Main_main_trace_s3_len equ 43
pulsec_strict_stress_soak_Main_main_trace_s4 db "strict_stress_soak.Main.main(Main.aden:11)"
pulsec_strict_stress_soak_Main_main_trace_s4_len equ 43
pulsec_strict_stress_soak_Main_main_trace_s5 db "strict_stress_soak.Main.main(Main.aden:13)"
pulsec_strict_stress_soak_Main_main_trace_s5_len equ 43
pulsec_strict_stress_soak_Main_main_trace_s6 db "strict_stress_soak.Main.main(Main.aden:14)"
