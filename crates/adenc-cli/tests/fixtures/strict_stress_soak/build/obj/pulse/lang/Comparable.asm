...
.data
written dq 0
pulsec_objc_pulse_lang_Comparable dd 0
trace_m0 db "pulse.lang.Comparable.compareTo"
trace_m0_len equ 31

.code
pulsec_pulse_lang_Comparable_compareTo__Object proc
    sub rsp, 200
...
pulsec_pulse_lang_Comparable_compareTo__Object_b0:
    xor eax, eax
    jmp pulsec_pulse_lang_Comparable_compareTo__Object_epilogue
pulsec_pulse_lang_Comparable_compareTo__Object_epilogue:
pulsec_pulse_lang_Comparable_compareTo__Object_epilogue_post:
    mov qword ptr [rsp+120], rax
    call pulsec_rt_tracePop
    mov rax, qword ptr [rsp+120]
    add rsp, 200
    ret
pulsec_pulse_lang_Comparable_compareTo__Object endp
