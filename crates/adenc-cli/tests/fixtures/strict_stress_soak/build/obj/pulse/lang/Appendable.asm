...
.data
written dq 0
pulsec_objc_pulse_lang_Appendable dd 0
trace_m0 db "pulse.lang.Appendable.append"
trace_m0_len equ 28
trace_m1 db "pulse.lang.Appendable.append"
trace_m1_len equ 28

.code
pulsec_pulse_lang_Appendable_append__String proc
    sub rsp, 200
...
pulsec_pulse_lang_Appendable_append__String_b0:
    xor eax, eax
    jmp pulsec_pulse_lang_Appendable_append__String_epilogue
pulsec_pulse_lang_Appendable_append__String_epilogue:
pulsec_pulse_lang_Appendable_append__String_epilogue_post:
    mov qword ptr [rsp+120], rax
    call pulsec_rt_tracePop
    mov rax, qword ptr [rsp+120]
    add rsp, 200
    ret
pulsec_pulse_lang_Appendable_append__String endp

pulsec_pulse_lang_Appendable_append__char proc
    sub rsp, 200
    mov qword ptr [rsp+168], rcx
    mov qword ptr [rsp+176], rdx
    mov qword ptr [rsp+184], r8
...
pulsec_pulse_lang_Appendable_append__char_b0:
    xor eax, eax
    jmp pulsec_pulse_lang_Appendable_append__char_epilogue
pulsec_pulse_lang_Appendable_append__char_epilogue:
pulsec_pulse_lang_Appendable_append__char_epilogue_post:
    mov qword ptr [rsp+120], rax
    call pulsec_rt_tracePop
    mov rax, qword ptr [rsp+120]
    add rsp, 200
    ret
pulsec_pulse_lang_Appendable_append__char endp
