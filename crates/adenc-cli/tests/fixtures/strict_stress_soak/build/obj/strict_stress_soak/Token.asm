...
trace_m0_len equ 30
pulsec_strict_stress_soak_Token_Token__int_trace_s0 db "strict_stress_soak.Token.Token(Token.aden:7)"
pulsec_strict_stress_soak_Token_Token__int_trace_s0_len equ 45
trace_m2 db "strict_stress_soak.Token.value"
trace_m2_len equ 30
pulsec_strict_stress_soak_Token_value_trace_s0 db "strict_stress_soak.Token.value(Token.aden:11)"
