...
.data
written dq 0
pulsec_objc_app_mixed_Main dd 0
trace_m0 db "app.mixed.Main.main"
trace_m0_len equ 19
pulsec_app_mixed_Main_main_trace_s0 db "app.mixed.Main.main(Main.aden:6)"
pulsec_app_mixed_Main_main_trace_s0_len equ 33
msg0 db "object_interface_mix_ok"
msg0_len equ 23

.code
pulsec_app_mixed_Main_main proc
    sub rsp, 232
...
pulsec_app_mixed_Main_main_b0:
    lea rcx, pulsec_app_mixed_Main_main_trace_s0
    mov edx, pulsec_app_mixed_Main_main_trace_s0_len
    ...
    mov rax, qword ptr [rsp+104]
    xor eax, eax
    jmp pulsec_app_mixed_Main_main_epilogue
pulsec_app_mixed_Main_main_epilogue:
pulsec_app_mixed_Main_main_epilogue_post:
    mov qword ptr [rsp+104], rax
    call pulsec_rt_tracePop
    mov rax, qword ptr [rsp+104]
    add rsp, 232
    ret
pulsec_app_mixed_Main_main endp
