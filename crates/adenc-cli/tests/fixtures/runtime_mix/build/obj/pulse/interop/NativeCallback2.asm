...
.data
written dq 0
pulsec_objc_pulse_interop_NativeCallback2 dd 0
trace_m0 db "pulse.interop.NativeCallback2.invoke"
trace_m0_len equ 36

.code
pulsec_pulse_interop_NativeCallback2_invoke__long_long proc
    sub rsp, 216
...
pulsec_pulse_interop_NativeCallback2_invoke__long_long_b0:
    xor eax, eax
    jmp pulsec_pulse_interop_NativeCallback2_invoke__long_long_epilogue
pulsec_pulse_interop_NativeCallback2_invoke__long_long_epilogue:
    mov qword ptr [rsp+128], rax
    mov rax, qword ptr [rsp+128]
pulsec_pulse_interop_NativeCallback2_invoke__long_long_epilogue_post:
    mov qword ptr [rsp+128], rax
    call pulsec_rt_tracePop
    mov rax, qword ptr [rsp+128]
    add rsp, 216
    ret
pulsec_pulse_interop_NativeCallback2_invoke__long_long endp
