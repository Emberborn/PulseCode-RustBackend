...
.data
written dq 0
pulsec_objc_pulse_interop_NativeCallback0 dd 0
trace_m0 db "pulse.interop.NativeCallback0.invoke"
trace_m0_len equ 36

.code
pulsec_pulse_interop_NativeCallback0_invoke proc
    sub rsp, 200
...
pulsec_pulse_interop_NativeCallback0_invoke_b0:
    xor eax, eax
    jmp pulsec_pulse_interop_NativeCallback0_invoke_epilogue
pulsec_pulse_interop_NativeCallback0_invoke_epilogue:
    mov qword ptr [rsp+112], rax
    mov rax, qword ptr [rsp+112]
pulsec_pulse_interop_NativeCallback0_invoke_epilogue_post:
    mov qword ptr [rsp+112], rax
    call pulsec_rt_tracePop
    mov rax, qword ptr [rsp+112]
    add rsp, 200
    ret
pulsec_pulse_interop_NativeCallback0_invoke endp
