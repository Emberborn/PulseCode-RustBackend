...
.data
written dq 0
pulsec_objc_pulse_interop_NativeCallback1 dd 0
trace_m0 db "pulse.interop.NativeCallback1.invoke"
trace_m0_len equ 36

.code
pulsec_pulse_interop_NativeCallback1_invoke__long proc
    sub rsp, 200
...
pulsec_pulse_interop_NativeCallback1_invoke__long_b0:
    xor eax, eax
    jmp pulsec_pulse_interop_NativeCallback1_invoke__long_epilogue
pulsec_pulse_interop_NativeCallback1_invoke__long_epilogue:
    mov qword ptr [rsp+120], rax
    mov rax, qword ptr [rsp+120]
pulsec_pulse_interop_NativeCallback1_invoke__long_epilogue_post:
    mov qword ptr [rsp+120], rax
    call pulsec_rt_tracePop
    mov rax, qword ptr [rsp+120]
    add rsp, 200
    ret
pulsec_pulse_interop_NativeCallback1_invoke__long endp
