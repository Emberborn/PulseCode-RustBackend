...
pub(crate) fn mangle_method_symbol(
    ...
    let mut out = String::from("adenc_");
...
pub(crate) fn mangle_field_symbol(package: &str, class_name: &str, field_name: &str) -> String {
    let mut out = String::from("adenc_fld_");
    append_sanitized(&mut out, package);
    out.push('_');
    append_sanitized(&mut out, class_name);
    out.push('_');
...
pub(crate) fn mangle_static_field_getter_symbol(
    ...
    let mut out = String::from("adenc_fget_");
    append_sanitized(&mut out, package);
    out.push('_');
    append_sanitized(&mut out, class_name);
    out.push('_');
...
pub(crate) fn mangle_static_field_setter_symbol(
    ...
    let mut out = String::from("adenc_fset_");
    append_sanitized(&mut out, package);
    out.push('_');
    append_sanitized(&mut out, class_name);
    out.push('_');
...
pub(crate) fn mangle_class_counter_symbol(package: &str, class_name: &str) -> String {
    let mut out = String::from("adenc_objc_");
    append_sanitized(&mut out, package);
    out.push('_');
    append_sanitized(&mut out, class_name);
    shorten_identifier(out)
...
pub(crate) fn mangle_class_field_capacity_symbol(package: &str, class_name: &str) -> String {
    let mut out = String::from("adenc_fcap_");
    append_sanitized(&mut out, package);
    out.push('_');
    append_sanitized(&mut out, class_name);
    shorten_identifier(out)
...
pub(crate) fn mangle_native_callback_dispatch_proc_symbol(arity: usize) -> String {
    shorten_identifier(format!("adenc_rt_invokeNativeCallback{}", arity))
}

pub(crate) fn mangle_native_callback_trampoline_symbol(arity: usize, slot: usize) -> String {
    shorten_identifier(format!("adenc_rt_nativeCallback{}_slot{}", arity, slot))
}
