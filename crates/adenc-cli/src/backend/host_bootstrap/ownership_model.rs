...
const RUNTIME_OWNERSHIP_MODEL_SCHEMA: &str = "adenc.runtime.ownership.rebase.v1";
...
const FORBIDDEN_BLENDS: &[&str] = &[
    "public-aden-surface-must-not-be-recast-as-adapter-owned",
    "runtime-private-state-must-not-become-app-or-stdlib-owned-storage",
    "windows-service-imports-must-not-become-portable-runtime-or-adenos-defaults",
...
pub(crate) struct RuntimeOwnershipModel {
    ...
    pub(crate) aden_owned_namespace_families: &'static [&'static str],
    pub(crate) aden_owned_rule: &'static str,
...
pub(crate) fn resolve_runtime_ownership_model(
    ...
    Ok(RuntimeOwnershipModel {
        ...
        aden_owned_namespace_families: PULSE_OWNED_NAMESPACE_FAMILIES,
        aden_owned_rule:
            "language-facing behavior belongs in Aden stdlib/runtime code unless it genuinely requires bootstrap runtime or adapter glue",
