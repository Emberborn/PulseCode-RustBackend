...
use adenc_core::{IrClass, IrMethod, IrProgram, IrVisibility};

const TRACE_PUSH_SYMBOL: &str = "adenc_rt_tracePush";
const TRACE_UPDATE_SYMBOL: &str = "adenc_rt_traceUpdateTop";
const TRACE_POP_SYMBOL: &str = "adenc_rt_tracePop";
const TRACE_DUMP_SYMBOL: &str = "adenc_rt_traceDump";
const EXC_PUSH_HANDLER_SYMBOL: &str = "adenc_rt_pushExceptionHandler";
const EXC_POP_HANDLER_SYMBOL: &str = "adenc_rt_popExceptionHandler";
const EXC_TAKE_PENDING_SYMBOL: &str = "adenc_rt_takePendingException";
const EXC_THROW_SYMBOL: &str = "adenc_rt_throw";
const WRITE_RAW_SYMBOL: &str = "adenc_rt_writeRaw";
const ARC_HEADER_SCHEMA: &str = "adenc.arc.header.v1";
...
const ARC_CYCLE_SCHEMA: &str = "adenc.arc.cycle.v1";
...
const ALLOCATOR_POLICY_SCHEMA: &str = "adenc.alloc.policy.v1";
...
const RT_OBJECT_COUNTER_SYMBOL: &str = "adenc_rt_obj_counter";
const RT_OBJECT_CLASS_IDS_SYMBOL: &str = "adenc_rt_obj_class_ids";
const RT_OBJECT_CLASS_IDS_INIT_SYMBOL: &str = "adenc_rt_obj_class_ids_init";
const RT_OBJECT_CLASS_IDS_HEAP_OWNED_SYMBOL: &str = "adenc_rt_obj_class_ids_heap_owned";
const OBJECT_NEW_SYMBOL: &str = "adenc_rt_objectNew";
const OBJECT_CLASS_ID_SYMBOL: &str = "adenc_rt_objectClassId";
const OBJECT_CLASS_NAME_SYMBOL: &str = "adenc_rt_objectClassName";
const OBJECT_HASH_CODE_SYMBOL: &str = "adenc_rt_objectHashCode";
const SYSTEM_CURRENT_TIME_MILLIS_SYMBOL: &str = "adenc_rt_currentTimeMillis";
const SYSTEM_NANO_TIME_SYMBOL: &str = "adenc_rt_nanoTime";
const SYSTEM_EXIT_SYMBOL: &str = "adenc_rt_systemExit";
const STRING_CHAR_AT_SYMBOL: &str = "adenc_rt_stringCharAt";
const CHAR_TO_STRING_SYMBOL: &str = "adenc_rt_charToString";
const DISPATCH_NULL_PANIC_SYMBOL: &str = "adenc_rt_dispatchNullReceiverPanic";
const DISPATCH_TYPE_PANIC_SYMBOL: &str = "adenc_rt_dispatchInvalidTypePanic";
...
const THREADING_MODEL_SCHEMA: &str = "adenc.runtime.threading.v1";
