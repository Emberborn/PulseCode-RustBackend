...
fn check_rejects_throw_for_non_throwable_values() {
    ...
    assert!(err
        .to_string()
        .contains("Cannot assign type 'String' to 'aden.lang.Throwable'"));
}
    ...
    let src = r#"
        ...
        class Main {
            public static void main() {
                ...
                aden.rt.Intrinsics.consoleWriteLine(text);
            }
        }
    "#;
