...
trace_m0_len equ 22
pulsec_pulse_lang_Class_Class__String_trace_s0 db "pulse.lang.Class.Class(Class.pulse:14)"
pulsec_pulse_lang_Class_Class__String_trace_s0_len equ 38
trace_m2 db "pulse.lang.Class.getName"
trace_m2_len equ 24
pulsec_pulse_lang_Class_getName_trace_s0 db "pulse.lang.Class.getName(Class.pulse:22)"
pulsec_pulse_lang_Class_getName_trace_s0_len equ 40
trace_m4 db "pulse.lang.Class.getSimpleName"
trace_m4_len equ 30
pulsec_pulse_lang_Class_getSimpleName_trace_s0 db "pulse.lang.Class.getSimpleName(Class.pulse:30)"
pulsec_pulse_lang_Class_getSimpleName_trace_s0_len equ 46
pulsec_pulse_lang_Class_getSimpleName_trace_s1 db "pulse.lang.Class.getSimpleName(Class.pulse:31)"
pulsec_pulse_lang_Class_getSimpleName_trace_s1_len equ 46
pulsec_pulse_lang_Class_getSimpleName_trace_s2 db "pulse.lang.Class.getSimpleName(Class.pulse:32)"
pulsec_pulse_lang_Class_getSimpleName_trace_s2_len equ 46
pulsec_pulse_lang_Class_getSimpleName_trace_s3 db "pulse.lang.Class.getSimpleName(Class.pulse:34)"
pulsec_pulse_lang_Class_getSimpleName_trace_s3_len equ 46
trace_m9 db "pulse.lang.Class.getPackageName"
trace_m9_len equ 31
pulsec_pulse_lang_Class_getPackageName_trace_s0 db "pulse.lang.Class.getPackageName(Class.pulse:42)"
pulsec_pulse_lang_Class_getPackageName_trace_s0_len equ 47
pulsec_pulse_lang_Class_getPackageName_trace_s1 db "pulse.lang.Class.getPackageName(Class.pulse:43)"
pulsec_pulse_lang_Class_getPackageName_trace_s1_len equ 47
pulsec_pulse_lang_Class_getPackageName_trace_s2 db "pulse.lang.Class.getPackageName(Class.pulse:44)"
pulsec_pulse_lang_Class_getPackageName_trace_s2_len equ 47
pulsec_pulse_lang_Class_getPackageName_trace_s3 db "pulse.lang.Class.getPackageName(Class.pulse:46)"
pulsec_pulse_lang_Class_getPackageName_trace_s3_len equ 47
trace_m14 db "pulse.lang.Class.toString"
trace_m14_len equ 25
pulsec_pulse_lang_Class_toString_trace_s0 db "pulse.lang.Class.toString(Class.pulse:54)"
pulsec_pulse_lang_Class_toString_trace_s0_len equ 41
msg0 db 0
msg0_len equ 0
...
pulsec_pulse_lang_Class_Class__String_b0:
    lea rcx, pulsec_pulse_lang_Class_Class__String_trace_s0
    mov edx, pulsec_pulse_lang_Class_Class__String_trace_s0_len
...
pulsec_pulse_lang_Class_getName_b0:
    lea rcx, pulsec_pulse_lang_Class_getName_trace_s0
    mov edx, pulsec_pulse_lang_Class_getName_trace_s0_len
    call pulsec_rt_traceUpdateTop
    mov edx, dword ptr [rsp+64]
    cmp edx, 4294967295
    jbe @F
...
pulsec_pulse_lang_Class_getSimpleName_b0:
    lea rcx, pulsec_pulse_lang_Class_getSimpleName_trace_s0
    mov edx, pulsec_pulse_lang_Class_getSimpleName_trace_s0_len
    call pulsec_rt_traceUpdateTop
...
@@:
    ...
    lea rcx, pulsec_pulse_lang_Class_getSimpleName_trace_s1
    mov edx, pulsec_pulse_lang_Class_getSimpleName_trace_s1_len
    call pulsec_rt_traceUpdateTop
...
pulsec_pulse_lang_Class_getSimpleName_b1:
    lea rcx, pulsec_pulse_lang_Class_getSimpleName_trace_s2
    mov edx, pulsec_pulse_lang_Class_getSimpleName_trace_s2_len
    call pulsec_rt_traceUpdateTop
    mov edx, dword ptr [rsp+72]
    cmp edx, 4294967295
    jbe @F
...
pulsec_pulse_lang_Class_getSimpleName_b3:
    lea rcx, pulsec_pulse_lang_Class_getSimpleName_trace_s3
    mov edx, pulsec_pulse_lang_Class_getSimpleName_trace_s3_len
    call pulsec_rt_traceUpdateTop
    mov edx, dword ptr [rsp+72]
    cmp edx, 4294967295
    jbe @F
...
pulsec_pulse_lang_Class_getPackageName_b0:
    lea rcx, pulsec_pulse_lang_Class_getPackageName_trace_s0
    mov edx, pulsec_pulse_lang_Class_getPackageName_trace_s0_len
    call pulsec_rt_traceUpdateTop
    mov edx, dword ptr [rsp+72]
    cmp edx, 4294967295
    jbe @F
...
@@:
    ...
    movsxd rax, eax
    mov dword ptr [rsp+64], eax
    lea rcx, pulsec_pulse_lang_Class_getPackageName_trace_s1
    mov edx, pulsec_pulse_lang_Class_getPackageName_trace_s1_len
    call pulsec_rt_traceUpdateTop
    mov eax, dword ptr [rsp+64]
    mov dword ptr [rsp+80], eax
    mov eax, 0
...
pulsec_pulse_lang_Class_getPackageName_b1:
    lea rcx, pulsec_pulse_lang_Class_getPackageName_trace_s2
    mov edx, pulsec_pulse_lang_Class_getPackageName_trace_s2_len
    call pulsec_rt_traceUpdateTop
    lea rcx, msg0
    mov edx, msg0_len
...
pulsec_pulse_lang_Class_getPackageName_b3:
    lea rcx, pulsec_pulse_lang_Class_getPackageName_trace_s3
    mov edx, pulsec_pulse_lang_Class_getPackageName_trace_s3_len
    call pulsec_rt_traceUpdateTop
    mov edx, dword ptr [rsp+72]
    cmp edx, 4294967295
    jbe @F
...
pulsec_pulse_lang_Class_toString_b0:
    lea rcx, pulsec_pulse_lang_Class_toString_trace_s0
    mov edx, pulsec_pulse_lang_Class_toString_trace_s0_len
    call pulsec_rt_traceUpdateTop
    mov edx, dword ptr [rsp+64]
    cmp edx, 4294967295
    jbe @F
