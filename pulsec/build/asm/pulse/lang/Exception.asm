...
trace_m0_len equ 30
pulsec_pulse_lang_Exception_Exception_trace_s0 db "pulse.lang.Exception.Exception(Exception.pulse:12)"
pulsec_pulse_lang_Exception_Exception_trace_s0_len equ 50
trace_m2 db "pulse.lang.Exception.Exception"
trace_m2_len equ 30
pulsec_pulse_lang_Exception_Exception__String_trace_s0 db "pulse.lang.Exception.Exception(Exception.pulse:20)"
pulsec_pulse_lang_Exception_Exception__String_trace_s0_len equ 50
trace_m4 db "pulse.lang.Exception.Exception"
trace_m4_len equ 30
pulsec_pulse_lang_Exception_Exception__String_Throwable_trace_s0 db "pulse.lang.Exception.Exception(Exception.pulse:28)"
pulsec_pulse_lang_Exception_Exception__String_Throwable_trace_s0_len equ 50
msg0 db "Exception"
msg0_len equ 9
msg1 db "Exception"
msg1_len equ 9
...
pulsec_pulse_lang_Exception_Exception_b0:
    lea rcx, pulsec_pulse_lang_Exception_Exception_trace_s0
    mov edx, pulsec_pulse_lang_Exception_Exception_trace_s0_len
...
pulsec_pulse_lang_Exception_Exception__String_b0:
    lea rcx, pulsec_pulse_lang_Exception_Exception__String_trace_s0
    mov edx, pulsec_pulse_lang_Exception_Exception__String_trace_s0_len
    call pulsec_rt_traceUpdateTop
    lea rcx, msg1
    mov edx, msg1_len
    call pulsec_rt_stringFromBytes
...
pulsec_pulse_lang_Exception_Exception__String_Throwable_b0:
    lea rcx, pulsec_pulse_lang_Exception_Exception__String_Throwable_trace_s0
    mov edx, pulsec_pulse_lang_Exception_Exception__String_Throwable_trace_s0_len
    call pulsec_rt_traceUpdateTop
    lea rcx, msg2
    mov edx, msg2_len
    call pulsec_rt_stringFromBytes
