...
.data
written dq 0
pulsec_objc_pulse_lang_Iterable dd 0
trace_m0 db "pulse.lang.Iterable.iterator"
trace_m0_len equ 28

.code
pulsec_pulse_lang_Iterable_iterator proc
    sub rsp, 200
...
pulsec_pulse_lang_Iterable_iterator_b0:
    xor eax, eax
    jmp pulsec_pulse_lang_Iterable_iterator_epilogue
pulsec_pulse_lang_Iterable_iterator_epilogue:
    mov qword ptr [rsp+112], rax
    mov rax, qword ptr [rsp+112]
pulsec_pulse_lang_Iterable_iterator_epilogue_post:
    mov qword ptr [rsp+112], rax
    call pulsec_rt_tracePop
    mov rax, qword ptr [rsp+112]
    add rsp, 200
    ret
pulsec_pulse_lang_Iterable_iterator endp
