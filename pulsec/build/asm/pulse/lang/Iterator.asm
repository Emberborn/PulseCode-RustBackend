...
.data
written dq 0
pulsec_objc_pulse_lang_Iterator dd 0
trace_m0 db "pulse.lang.Iterator.hasNext"
trace_m0_len equ 27
trace_m1 db "pulse.lang.Iterator.next"
trace_m1_len equ 24

.code
pulsec_pulse_lang_Iterator_hasNext proc
    sub rsp, 200
...
pulsec_pulse_lang_Iterator_hasNext_b0:
    xor eax, eax
    jmp pulsec_pulse_lang_Iterator_hasNext_epilogue
pulsec_pulse_lang_Iterator_hasNext_epilogue:
    mov qword ptr [rsp+112], rax
    mov rax, qword ptr [rsp+112]
pulsec_pulse_lang_Iterator_hasNext_epilogue_post:
    mov qword ptr [rsp+112], rax
    call pulsec_rt_tracePop
    mov rax, qword ptr [rsp+112]
    add rsp, 200
    ret
pulsec_pulse_lang_Iterator_hasNext endp

pulsec_pulse_lang_Iterator_next proc
    sub rsp, 200
    mov qword ptr [rsp+168], rcx
    mov qword ptr [rsp+176], rdx
    mov qword ptr [rsp+184], r8
    ...
    mov r9, qword ptr [rsp+192]
    mov qword ptr [rsp+64], rcx
pulsec_pulse_lang_Iterator_next_b0:
    xor eax, eax
    jmp pulsec_pulse_lang_Iterator_next_epilogue
pulsec_pulse_lang_Iterator_next_epilogue:
    mov qword ptr [rsp+112], rax
    mov rax, qword ptr [rsp+112]
pulsec_pulse_lang_Iterator_next_epilogue_post:
    mov qword ptr [rsp+112], rax
    call pulsec_rt_tracePop
    mov rax, qword ptr [rsp+112]
    add rsp, 200
    ret
pulsec_pulse_lang_Iterator_next endp
