...
extrn adenc_adk_compiler_entry_CompilerIdentity_banner:proc
...
.data
written dq 0
adenc_objc_adk_compiler_entry_Main dd 0
trace_m0 db "adk.compiler.entry.Main.main"
trace_m0_len equ 28
adenc_adk_compiler_entry_Main_main_trace_s0 db "adk.compiler.entry.Main.main(Main.aden:7)"
adenc_adk_compiler_entry_Main_main_trace_s0_len equ 41

.code
adenc_adk_compiler_entry_Main_main proc
    sub rsp, 264
...
adenc_adk_compiler_entry_Main_main_b0:
    lea rcx, adenc_adk_compiler_entry_Main_main_trace_s0
    mov edx, adenc_adk_compiler_entry_Main_main_trace_s0_len
    call adenc_rt_traceUpdateTop
    call adenc_adk_compiler_entry_CompilerIdentity_banner
    ...
    mov rax, qword ptr [rsp+104]
    xor eax, eax
    jmp adenc_adk_compiler_entry_Main_main_epilogue
adenc_adk_compiler_entry_Main_main_epilogue:
    mov qword ptr [rsp+104], rax
    mov rax, qword ptr [rsp+104]
adenc_adk_compiler_entry_Main_main_epilogue_post:
    mov qword ptr [rsp+104], rax
    call adenc_rt_tracePop
    mov rax, qword ptr [rsp+104]
    add rsp, 264
    ret
adenc_adk_compiler_entry_Main_main endp
