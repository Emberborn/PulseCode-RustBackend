...
.data
written dq 0
adenc_objc_aden_lang_Iterable dd 0
trace_m0 db "aden.lang.Iterable.iterator"
trace_m0_len equ 27

.code
adenc_aden_lang_Iterable_iterator proc
    sub rsp, 200
...
adenc_aden_lang_Iterable_iterator_b0:
    xor eax, eax
    jmp adenc_aden_lang_Iterable_iterator_epilogue
adenc_aden_lang_Iterable_iterator_epilogue:
    mov qword ptr [rsp+112], rax
    mov rax, qword ptr [rsp+112]
adenc_aden_lang_Iterable_iterator_epilogue_post:
    mov qword ptr [rsp+112], rax
    call adenc_rt_tracePop
    mov rax, qword ptr [rsp+112]
    add rsp, 200
    ret
adenc_aden_lang_Iterable_iterator endp
