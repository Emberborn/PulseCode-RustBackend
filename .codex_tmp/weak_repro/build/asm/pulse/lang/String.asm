...
msg7 db 0
msg7_len equ 0
msg8 db "String.replace target must not be null"
msg8_len equ 38
msg9 db "String.replace replacement must not be null"
msg9_len equ 43
msg10 db 0
msg10_len equ 0
msg11 db 0
...
msg13 db 0
msg13_len equ 0
msg14 db "String.removePrefix prefix must not be null"
msg14_len equ 43
msg15 db "String.removeSuffix suffix must not be null"
msg15_len equ 43
msg16 db 0
msg16_len equ 0
msg17 db 0
msg17_len equ 0
msg18 db "String.split delimiter must not be null"
msg18_len equ 39
msg19 db "String.split delimiter must not be empty"
msg19_len equ 40
msg20 db "String.join delimiter must not be null"
msg20_len equ 38
msg21 db "String.join parts must not be null"
msg21_len equ 34
msg22 db 0
msg22_len equ 0
msg23 db "Invalid cast"
msg23_len equ 12
msg24 db "String.getChars destination must not be null"
msg24_len equ 44
msg25 db "String.getChars source range out of bounds"
msg25_len equ 42
msg26 db "String.getChars destination range out of bounds"
msg26_len equ 47
msg27 db "0"
msg27_len equ 1
msg28 db "-2147483648"
...
msg33 db "null"
msg33_len equ 4
msg34 db "Invalid cast"
msg34_len equ 12
msg35 db "String.copyValueOf value must not be null"
msg35_len equ 41
msg36 db "String.copyValueOf value must not be null"
msg36_len equ 41
msg37 db "String.copyValueOf range out of bounds"
msg37_len equ 38
msg38 db 0
msg38_len equ 0
msg39 db "0"
...
pulsec_pulse_lang_String_compareTo__String proc
    sub rsp, 360
...
pulsec_pulse_lang_String_compareTo__String_b0:
    mov rax, qword ptr [rsp+120]
    mov qword ptr [rsp+128], rax
    xor eax, eax
    mov rdx, rax
    ...
    movzx eax, al
    test eax, eax
    jne pulsec_pulse_lang_String_compareTo__String_b1
    jmp pulsec_pulse_lang_String_compareTo__String_b2
pulsec_pulse_lang_String_compareTo__String_b1:
    lea rcx, msg3
    mov edx, msg3_len
    call pulsec_rt_stringFromBytes
    ...
    call pulsec_rt_arcRelease
    mov rax, qword ptr [rsp+232]
    jmp pulsec_pulse_lang_String_compareTo__String_b3
pulsec_pulse_lang_String_compareTo__String_b2:
    jmp pulsec_pulse_lang_String_compareTo__String_b3
pulsec_pulse_lang_String_compareTo__String_b3:
    ...
    movzx eax, al
    test eax, eax
    jne pulsec_pulse_lang_String_compareTo__String_b4
    jmp pulsec_pulse_lang_String_compareTo__String_b5
pulsec_pulse_lang_String_compareTo__String_b4:
    mov eax, dword ptr [rsp+72]
    mov dword ptr [rsp+80], eax
    jmp pulsec_pulse_lang_String_compareTo__String_b6
pulsec_pulse_lang_String_compareTo__String_b5:
    jmp pulsec_pulse_lang_String_compareTo__String_b6
pulsec_pulse_lang_String_compareTo__String_b6:
    mov eax, 0
    mov dword ptr [rsp+88], eax
    jmp pulsec_pulse_lang_String_compareTo__String_b7
pulsec_pulse_lang_String_compareTo__String_b7:
    mov eax, dword ptr [rsp+88]
    mov dword ptr [rsp+144], eax
    mov eax, dword ptr [rsp+80]
    mov edx, eax
    ...
    movzx eax, al
    test eax, eax
    jne pulsec_pulse_lang_String_compareTo__String_b8
    jmp pulsec_pulse_lang_String_compareTo__String_b9
pulsec_pulse_lang_String_compareTo__String_b8:
    mov eax, dword ptr [rsp+88]
    mov qword ptr [rsp+232], rax
    mov rax, qword ptr [rsp+232]
    and rax, 0FFFFFFFFh
    ...
    movzx eax, al
    test eax, eax
    jne pulsec_pulse_lang_String_compareTo__String_b10
    jmp pulsec_pulse_lang_String_compareTo__String_b11
pulsec_pulse_lang_String_compareTo__String_b9:
    mov eax, dword ptr [rsp+64]
    ...
    movzx eax, al
    test eax, eax
    jne pulsec_pulse_lang_String_compareTo__String_b16
    jmp pulsec_pulse_lang_String_compareTo__String_b17
pulsec_pulse_lang_String_compareTo__String_b10:
    mov eax, 1
    neg eax
    jmp pulsec_pulse_lang_String_compareTo__String_epilogue
pulsec_pulse_lang_String_compareTo__String_b11:
    jmp pulsec_pulse_lang_String_compareTo__String_b12
pulsec_pulse_lang_String_compareTo__String_b12:
    mov eax, dword ptr [rsp+96]
    mov dword ptr [rsp+160], eax
    mov eax, dword ptr [rsp+104]
    mov edx, eax
    ...
    movzx eax, al
    test eax, eax
    jne pulsec_pulse_lang_String_compareTo__String_b13
    jmp pulsec_pulse_lang_String_compareTo__String_b14
pulsec_pulse_lang_String_compareTo__String_b13:
    mov eax, 1
    jmp pulsec_pulse_lang_String_compareTo__String_epilogue
pulsec_pulse_lang_String_compareTo__String_b14:
    jmp pulsec_pulse_lang_String_compareTo__String_b15
pulsec_pulse_lang_String_compareTo__String_b15:
    mov eax, dword ptr [rsp+88]
    ...
    mov dword ptr [rsp+88], eax
    jmp pulsec_pulse_lang_String_compareTo__String_b7
pulsec_pulse_lang_String_compareTo__String_b16:
    mov eax, 1
    neg eax
    jmp pulsec_pulse_lang_String_compareTo__String_epilogue
pulsec_pulse_lang_String_compareTo__String_b17:
    jmp pulsec_pulse_lang_String_compareTo__String_b18
pulsec_pulse_lang_String_compareTo__String_b18:
    mov eax, dword ptr [rsp+64]
    ...
    movzx eax, al
    test eax, eax
    jne pulsec_pulse_lang_String_compareTo__String_b19
    jmp pulsec_pulse_lang_String_compareTo__String_b20
pulsec_pulse_lang_String_compareTo__String_b19:
    mov eax, 1
    jmp pulsec_pulse_lang_String_compareTo__String_epilogue
pulsec_pulse_lang_String_compareTo__String_b20:
    jmp pulsec_pulse_lang_String_compareTo__String_b21
pulsec_pulse_lang_String_compareTo__String_b21:
    mov eax, 0
    jmp pulsec_pulse_lang_String_compareTo__String_epilogue
pulsec_pulse_lang_String_compareTo__String_epilogue:
    mov qword ptr [rsp+232], rax
    mov rax, qword ptr [rsp+232]
pulsec_pulse_lang_String_compareTo__String_epilogue_post:
    mov qword ptr [rsp+232], rax
    call pulsec_rt_tracePop
    mov rax, qword ptr [rsp+232]
    add rsp, 360
    ret
pulsec_pulse_lang_String_compareTo__String endp
