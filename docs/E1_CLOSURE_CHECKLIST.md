...
- E1 covers real shared-library native output for PulseCode:
...
- [x] [E1_TASK_BOARD.md](/D:/Programming/codex/PulseCode/docs/E1_TASK_BOARD.md)
- [x] [E1_SHARED_BUILD_GUIDE.md](/D:/Programming/codex/PulseCode/docs/E1_SHARED_BUILD_GUIDE.md)
- [x] [E1_EVIDENCE_INDEX.md](/D:/Programming/codex/PulseCode/docs/E1_EVIDENCE_INDEX.md)
...
- E1 is closed.
- Tasks `E1-01`..`E1-21` and gates `E1-G1`..`E1-G6` are `Done (Locked)` in [E1_TASK_BOARD.md](/D:/Programming/codex/PulseCode/docs/E1_TASK_BOARD.md).
