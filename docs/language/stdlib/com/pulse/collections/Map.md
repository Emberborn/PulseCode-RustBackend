...
Source: ``stdlib/src/com/pulse/collections/Map.pulse``

## Summary

Runtime-backed generic map facade retained for simple key/value flows.
...
Creates an empty runtime-backed map.
