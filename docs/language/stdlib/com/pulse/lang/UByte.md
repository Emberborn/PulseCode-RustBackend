...
Source: ``stdlib/src/com/pulse/lang/UByte.pulse``

## Summary

Wrapper facade for unsigned 8-bit Pulse extension values.
...
Use this when formatting Pulse extension `ubyte` values.
