...
Source: ``stdlib/src/com/pulse/lang/UShort.pulse``

## Summary

Wrapper facade for unsigned 16-bit Pulse extension values.
...
Use this when formatting Pulse extension `ushort` values.
