...
Source: ``stdlib/src/aden/lang/IO.aden``
...
Use this for straightforward retained Aden unsigned-byte console output.

### ``public static void println(ushort value)``

Writes an unsigned short and terminates the line.
Use this for straightforward retained Aden unsigned-short console output.

### ``public static void println(uint value)``

Writes an unsigned int and terminates the line.
Use this for straightforward retained Aden unsigned-int console output.

### ``public static void println(ulong value)``

Writes an unsigned long and terminates the line.
Use this for straightforward retained Aden unsigned-long console output.
...
Use this for incremental retained Aden unsigned-byte console output.

### ``public static void print(ushort value)``

Writes an unsigned short without a trailing newline.
Use this for incremental retained Aden unsigned-short console output.

### ``public static void print(uint value)``

Writes an unsigned int without a trailing newline.
Use this for incremental retained Aden unsigned-int console output.

### ``public static void print(ulong value)``

Writes an unsigned long without a trailing newline.
Use this for incremental retained Aden unsigned-long console output.
