# aden.interop.NativeCallback3

Kind: ``interface``

Source: ``stdlib/src/aden/interop/NativeCallback3.aden``

## Summary

Raw three-argument native callback contract returning one host-ABI `long`.
Use this at the public interop boundary when foreign code calls back into Aden with three raw scalar/pointer arguments.
