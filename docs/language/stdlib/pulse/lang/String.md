...
Source: ``stdlib/src/pulse/lang/String.pulse``
...
Returns a copy of this string with leading and trailing ASCII whitespace removed.
Use this as the current Pulse-owned strip baseline without introducing Unicode whitespace policy yet.
...
Use this for practical fixed-width formatting while keeping the behavior Pulse-owned.
...
Use this for practical non-regex text splitting without pulling collection types into `pulse.lang`.
...
Use this when formatting retained Pulse unsigned-byte values through the standard string surface.

### ``public static String valueOf(ushort value)``

Converts an unsigned short value into its string representation.
Use this when formatting retained Pulse unsigned-short values through the standard string surface.

### ``public static String valueOf(uint value)``

Converts an unsigned int value into its string representation.
Use this when formatting retained Pulse unsigned-int values through the standard string surface.

### ``public static String valueOf(ulong value)``

Converts an unsigned long value into its string representation.
Use this when formatting retained Pulse unsigned-long values through the standard string surface.
