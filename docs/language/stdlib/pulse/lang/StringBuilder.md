# pulse.lang.StringBuilder

Kind: ``class``

Source: ``stdlib/src/pulse/lang/StringBuilder.pulse``
...
Use this when mixing retained Pulse unsigned-byte output into a builder chain.

### ``public StringBuilder append(ushort value)``

Appends an unsigned short value after converting it to text.
Use this when mixing retained Pulse unsigned-short output into a builder chain.

### ``public StringBuilder append(uint value)``

Appends an unsigned int value after converting it to text.
Use this when mixing retained Pulse unsigned-int output into a builder chain.

### ``public StringBuilder append(ulong value)``

Appends an unsigned long value after converting it to text.
Use this when mixing retained Pulse unsigned-long output into a builder chain.
...
Use this for practical line-oriented retained Pulse unsigned-byte output.
...
Use this when builder edits need retained Pulse unsigned-byte text at a specific offset.

### ``public StringBuilder insert(int index, ushort value)``

Inserts an unsigned short after converting it to text.
Use this when builder edits need retained Pulse unsigned-short text at a specific offset.

### ``public StringBuilder insert(int index, uint value)``

Inserts an unsigned int after converting it to text.
Use this when builder edits need retained Pulse unsigned-int text at a specific offset.

### ``public StringBuilder insert(int index, ulong value)``

Inserts an unsigned long after converting it to text.
Use this when builder edits need retained Pulse unsigned-long text at a specific offset.
