# pulse.interop.NativeCallback4

Kind: ``interface``

Source: ``stdlib/src/pulse/interop/NativeCallback4.pulse``

## Summary

Raw four-argument native callback contract returning one host-ABI `long`.
Use this at the public interop boundary when foreign code calls back into Pulse with four raw scalar/pointer arguments.
